...
<!--Commenting out this line removes the breadcrumbs along the top of the page.    <p id="simple-pages-breadcrumbs"><?php echo simple_pages_display_breadcrumbs(); ?></p> -->
    <?php endif; ?>
...
<?php if (!simple_pages_is_home_page(get_current_simple_page())): ?>
<!-- This comments out the bullet points with SimplePages navigation.  <div id="secondary">
