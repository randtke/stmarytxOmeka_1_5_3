...
<table>
<tr>
<th width="20%"><h2>Title</h2></br><a href="<?php echo $sortBy->get_link('dc.title'); ?>" title="Sort by title">Sort by Title</a></th>
<th width="10%"><h2>Date</h2></br><a href="<?php echo $sortBy->get_link('dc.date'); ?>" title="Sort by modified">Sort by Date</a></th>
<th width="15%"><h2>Author</h2></br><a href="<?php echo $sortBy->get_link('dc.creator'); ?>" title="Sort by modified">Sort by Author</a></th>
<th width="45%"><h2>Description</h2></th>
<th width="10%"><h2>Download Files</h2></th></tr>
...
-->
		    ...
		    <div class="item-description">
        <?php echo __('<strong>Download Files:</strong>'); ?></h3>
